...
#ifndef ROCE_SIMULATION_TAG_H
#define ROCE_SIMULATION_TAG_H
...
/** Simulation-only metadata; it does not contribute bytes to the RoCEv2 wire image. */
class RoceSimulationTag : public Tag
{
  public:
