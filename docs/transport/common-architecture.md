...
The Falcon module has entered phase P2 with the OCP Falcon 1.1 base, Push Data, Pull Request,
BACK, EACK and NACK wire layouts plus independent data/request reliability windows. It is not
registered with the workload driver until the reliable packet-delivery adapter is available; see
